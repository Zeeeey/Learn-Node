...
exports.resize = async(req, res, next) => {
    ...
    // console.log('here is the pic', req.file);
    ...
    // once we have the photo to our filesystem, keep going
    next();
}
...
exports.getStoresByTag = async(req, res) => {
    ...
    // const result = await Promise.all([tagsPromise, storesPromise]); // destructured result below
    const [tags, stores] = await Promise.all([tagsPromise, storesPromise]);
    res.render('tag', { tag, tags, stores });
}
